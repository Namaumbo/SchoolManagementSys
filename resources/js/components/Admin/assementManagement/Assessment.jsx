...
import { FiGitMerge, FiHome } from "react-icons/fi";
...
const Assessment = () => {
    ...
    return (
        <>
            ...
            {loggedIn && (role === "Head teacher" || role === "Admin") && (
                <div className="assessment-main">
                    <div className="user-tb">
                        ...
                        <div className="main-btns">
                            <button className="btn btn-success ">Save History</button>
                            <span> </span>
            ...
            {loggedIn && role === "Teacher" && (
                <div className="heading">
                    <FiHome />
                    <span style={{ color: "white" }}>Teacher-Assessment</span>
                </div>
            )}
        </>
    );
