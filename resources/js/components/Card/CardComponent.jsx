  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 to-purple-600">
      <div className="bg-white shadow-2xl rounded-lg p-8 w-full max-w-2xl">
        <h3 className="text-3xl font-bold mb-4 text-center text-gray-800">School Details</h3>
        <p className="text-gray-600 text-center mb-6">Enter your school information.</p>
        <div className="space-y-6">
          <div>
            <label htmlFor="school-name" className="block text-sm font-bold mb-2 text-gray-700">
              School Name
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="school-address" className="block text-sm font-bold mb-2 text-gray-700">
              School Address
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="school-phone" className="block text-sm font-bold mb-2 text-gray-700">
              School Phone Number
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="school-logo" className="block text-sm font-bold mb-2 text-gray-700">
              School Logo
            </label>
            <input
              type="file"
